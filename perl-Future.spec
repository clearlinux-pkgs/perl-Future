...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-0.44.tar.gz
...
%prep
%setup -q -n Future-0.44
cd %{_builddir}/Future-0.44
...
cp %{_builddir}/Future-0.44/LICENSE %{buildroot}/usr/share/package-licenses/perl-Future/7e88e362b09da4b18d7e611c14945b5734383496
if test -f Makefile.PL; then
