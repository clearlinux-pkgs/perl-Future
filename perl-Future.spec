...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-0.41.tar.gz
...
%prep
%setup -q -n Future-0.41
cd ..
%setup -q -T -D -n Future-0.41 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Future-0.41/deblicense/
