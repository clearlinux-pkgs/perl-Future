...
Version  : 0.49
Release  : 30
URL      : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-0.49.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-0.49.tar.gz
...
%prep
%setup -q -n Future-0.49
cd %{_builddir}/Future-0.49
...
cp %{_builddir}/Future-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Future/1a0db8ae53618717535b6c54006100fc3e919f87 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Future/1a0db8ae53618717535b6c54006100fc3e919f87
